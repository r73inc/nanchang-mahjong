...
- **Primary:** Gold gradient (top: #c9a961, bottom: #a88a45), dark slate text (#1f2937), 14px vertical / 20px horizontal padding, CTA glow shadow. Full-width on mobile. On disabled: 70% opacity, `cursor-wait`.
- **Primary Hover:** Shift gradient to gold-deep (#a88a45) solid; glow shadow persists.
- **Ghost/Secondary:** Transparent background, bone/15 border, bone text. Same radius and padding as primary. No shadow.
...
- **Label above:** 11px, semibold, 70% opacity, uppercase, 0.5px tracking.
