      ...
      {seat.avatarUrl && (
        <img
          ...
          style={{
            ...
            flexShrink: 0,
            // Pin avatar to the same edge as the badge pill. 'center' caused the
            // avatar to drift inward as open melds widened the flex column.
            alignSelf:
              position === 'left' ? 'flex-start' : position === 'right' ? 'flex-end' : undefined,
          }}
        />
      )}
